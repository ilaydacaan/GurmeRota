...
const GirisYap = (props) => {
  ...
  const hundleSubmit = async () => {
    if (email === '' || password === '') {
      ...
      navigator.navigate('AcilisEkrani')
    }
  }
  return (
    <Background>
      <View style={{ alignItems: 'center', width: 460 }}>
        ...
        <View
          ...
          />
          <Field placeholder="Şifrenizi giriniz" secureTextEntry={true} value={password} onChangeText={(text) => setPassword(text)} />
          <View
          ...
          <Btn textColor='white' bgColor={'#006A42'} btnLabel="Giriş Yap" Press={() => hundleSubmit()} />
